...
{
    public class GioHangController : Controllers
    {
        ...
        public List<GioHang> LayGioHang()
        {
            ...
            if (lstGioHang == null)
            {
                //Nếu giỏ hàng chưa tồn tại thì mình tiến hành khởi tạo list giỏ hàng (sessionGioHang)
        ...
        //Xây dựng 1 view cho người dùng chỉnh giỏ hàng
